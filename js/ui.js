...
const UI = {
                ...
                div.innerHTML = `
                    ...
                    <div class="details">
                        ...
                        <div class="v-meta">
                            ...
                            <span class="block-btn" onclick="app.blockChannel('${esc(v.channelId)}', ${JSON.stringify(v.author || '')})">Block</span>
                        </div>
                    </div>
                `;
                container.appendChild(div);
    ...
    setupPlayer: (data, videoId) => {
        ...
        document.getElementById('c-icon').src = meta.thumbnail ? meta.thumbnail : `https://ui-avatars.com/api/?name=${meta.author}`;
    ...
    showMiniPlayer: (title) => {
        ...
        info.textContent = title || 'Playing...';
    },
    hideMiniPlayer: () => {
